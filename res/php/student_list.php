...
// $admin = $_REQUEST['admin'];
 ...
 $sql = "select class_id, s.student_id, s.student_name, a.attendance_date, a.attendance_state from attendance a, student s, classmate_list c where a.student_id = s.student_id and s.student_id = c.student_id and
 a.attendance_date = '$date' and class_id in (select class.class_id from class, teacher where class.teacher_id = teacher.teacher_id and class.class_name='$class_name' and teacher.teacher_id =
 '$id')";
